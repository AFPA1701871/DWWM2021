<?php //Fonctions avec les fonctions natives de PHP
    ...
    function fonctionPurge($phrase,$valeurPurge){ //ex2 - Enlever une lettre d'une phrase - test
        ...
        while ($boolean=true){
            $boolean=false;
            if (array_search($valeurPurge, $phrase)){
                unset($phrase[array_search($valeurPurge, $phrase)]);
                $boolean=true;
            }
        }
