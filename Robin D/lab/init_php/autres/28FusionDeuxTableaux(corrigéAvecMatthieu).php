<?php
    ...
    for ($i=0; $i < $longueurTableau3; $i++) { 
        if ($curseurTableau1>=$longueurTableau1) {
            $tableau3[$i]=$tableau2[$curseurTableau2];
            $curseurTableau2=$curseurTableau2+1;
        }
        elseif ($curseurTableau2>=$longueurTableau2) {
        ...
        elseif ($tableau1[$curseurTableau1]<$tableau2[$curseurTableau2]) {
            $tableau3[$i]=$tableau1[$curseurTableau1];
            ($curseurTableau1<=$longueurTableau1-1)?$curseurTableau1=$curseurTableau1+1:NULL;
        }
        else {
            $tableau3[$i]=$tableau2[$curseurTableau2];
            ($curseurTableau2<=$longueurTableau2-1)?$curseurTableau2=$curseurTableau2+1:NULL;
        }
    }
